<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPanel.aspx.cs" Inherits="ProjectCostBenefitAnalysis.AdminPanel" %>
                ...
                <form class="login100-form validate-form" runat="server" style="width: 650px;">
                        ...
                        <div class="container-fluid">
                            <div class="row" style="width: 1620px">
                                ...
                                <div class="col-md-4" style="padding-top: 5px">
                                    <asp:Button ID="Btn_LogOut" runat="server" Text="Log Out" class="btn btn-danger" Height="35" Width="150" OnClick="Btn_LogOut_Click" style="float:right"/>
                                </div>
                            </div>
                        </div>
                    </nav>
                    <div class="row" style="padding-left: 30px; padding-top: 70px; width: 1250px">
                        <div class="col-md-6" style="padding-left: 50px; padding-top: 20px">
                            <asp:TextBox ID="Txt_Question" runat="server" Width="750px" CssClass="MyTextbox"></asp:TextBox><br />
                            <asp:Button ID="Btn_AddQuestion" runat="server" Text="Add Question" OnClick="Btn_AddQuestion_Click" class="btn btn-danger" Height="35px" />
                            <asp:Label ID="Lbl_QuestionLimit" runat="server" Text=""></asp:Label><br />
                            <br />
                            <asp:GridView ID="Grd_Questions" runat="server" OnSelectedIndexChanged="Grd_Questions_SelectedIndexChanged">
                                <Columns>
                                    <asp:CommandField ShowSelectButton="True" SelectText="Delete" />
                                </Columns>
                            </asp:GridView>
                            <br />
                            <asp:DropDownList ID="Ddl_AllUsers" runat="server" CssClass="MyTextbox" AutoPostBack="True" OnSelectedIndexChanged="Ddl_AllUsers_SelectedIndexChanged" AppendDataBoundItems="true">
                              

                            </asp:DropDownList>
                            <asp:DropDownList ID="Ddl_AllProjects" runat="server" CssClass="MyTextbox" AutoPostBack="True" enabled="false" AppendDataBoundItems="true"></asp:DropDownList><br />
                            <asp:Button ID="Btn_GetUserData" runat="server" Text="Get Data" OnClick="Btn_GetUserData_Click" class="btn btn-danger" Height="35px" /><br />
                            <br />
                            <asp:GridView ID="Grd_ViewUserData" runat="server"></asp:GridView>
                            <asp:GridView ID="Grd_ViewUserAnswers" runat="server"></asp:GridView>
                            <asp:GridView ID="Grd_ViewUserCostProfile" runat="server"></asp:GridView>
                            <asp:GridView ID="Grd_ViewUserBenefitsProfile" runat="server"></asp:GridView>
