...
namespace ProjectCostBenefitAnalysis
{
    ...
    public partial class CostProfile
    {
        public int CostProfileId { get; set; }
        public Nullable<int> UserId { get; set; }
        public Nullable<int> ProjectId { get; set; }
        public string ProposedProduct { get; set; }
        public Nullable<System.DateTime> DateConducte { get; set; }
        public string CompletedBy { get; set; }
        public Nullable<int> CostCategoryId { get; set; }
        public Nullable<int> OpexCapex { get; set; }
