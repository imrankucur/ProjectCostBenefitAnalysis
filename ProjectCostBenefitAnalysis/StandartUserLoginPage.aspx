<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StandartUserLoginPage.aspx.cs" Inherits="ProjectCostBenefitAnalysis.StandartUserLoginPage" %>
            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" runat="server">
                    ...
                    <div class="wrap-input100 ">
                        <asp:TextBox ID="Txt_StandartUserUsername" runat="server" class="input100" placeholder="Username" required></asp:TextBox>
                    ...
                    <div class="wrap-input100 ">
                        <asp:TextBox ID="Txt_StandartUserPassword" runat="server" input type="password" class="input100" placeholder="Password" required></asp:TextBox>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <div class="container-login100-form-btn">
                        <asp:Button ID="Btn_StandartUserLogin" runat="server" Text="Login" OnClick="Btn_StandartUserLogin_Click" class="login100-form-btn" />
                    </div>
                    <div class="text-center p-t-136">
                        <asp:Button ID="Btn_CreateYourAccount" runat="server" Text="Create your Account" CausesValidation="false" UseSubmitBehavior="false" class="login100" OnClick="Btn_CreateYourAccount_Click" />
                    </div>
                </form>
            </div>
        </div>
